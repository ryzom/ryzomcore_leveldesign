...
def writeNpcCreature(name, type, level, spec, actionlist):
	...
	with open(folder + "\\" + name + ".creature", "w") as f:
		...
		f.write("      <ATOM Name=\"Fear\" Value=\"" + str(varyLevel(defenseLevel, "Fear" + name)) + "\"/>\n")
		f.write("      <ATOM Name=\"Sleep\" Value=\"" + str(varyLevel(defenseLevel, "Sleep" + name)) + "\"/>\n")
		f.write("      <ATOM Name=\"Stun\" Value=\"" + str(varyLevel(defenseLevel, "Stun" + name)) + "\"/>\n")
		f.write("      <ATOM Name=\"Root\" Value=\"" + str(varyLevel(defenseLevel, "Root" + name)) + "\"/>\n")
		f.write("      <ATOM Name=\"Blind\" Value=\"" + str(varyLevel(defenseLevel, "Blind" + name)) + "\"/>\n")
		f.write("      <ATOM Name=\"Snare\" Value=\"" + str(varyLevel(defenseLevel, "Snare" + name)) + "\"/>\n")
		f.write("      <ATOM Name=\"Slow\" Value=\"" + str(varyLevel(defenseLevel, "Slow" + name)) + "\"/>\n")
		f.write("      <ATOM Name=\"Acid\" Value=\"" + str(varyLevel(defenseLevel, "Acid" + name)) + "\"/>\n")
		f.write("      <ATOM Name=\"Cold\" Value=\"" + str(varyLevel(defenseLevel, "Cold" + name)) + "\"/>\n")
		f.write("      <ATOM Name=\"Electricity\" Value=\"" + str(varyLevel(defenseLevel, "Electricity" + name)) + "\"/>\n")
		f.write("      <ATOM Name=\"Fire\" Value=\"" + str(varyLevel(defenseLevel, "Fire" + name)) + "\"/>\n")
		f.write("      <ATOM Name=\"Poison\" Value=\"" + str(varyLevel(defenseLevel, "Poison" + name)) + "\"/>\n")
		f.write("      <ATOM Name=\"Rot\" Value=\"" + str(varyLevel(defenseLevel, "Rot" + name)) + "\"/>\n")
		f.write("    </STRUCT>\n")
