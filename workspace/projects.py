...
InstallShardDataPrimitivesDirectories += [ [ "data_fyros_primitives", [ "fyros", "fyros/nland", "fyros/dunesofexil", "fyros/frahartowers", "fyros/imperialdunes", "fyros/oflovaksoasis", "fyros/outlawcanyon", "fyros/sawdustmines", "fyros/thesavagedunes", "fyros/thescorchedcorridor" ] ] ]
InstallShardDataPrimitivesDirectories += [ [ "data_tryker_primitives", [ "tryker", "tryker/nland", "tryker/bountybeaches", "tryker/dewdrops", "tryker/enchantedisle", "tryker/lagoonsofloria", "tryker/libertylake", "tryker/restingwater", "tryker/thefount", "tryker/windsofmuse" ] ] ]
...
InstallShardDataPrimitivesDirectories += [ [ "data_matis_primitives", [ "matis", "matis/nland", "matis/matis_island", "matis/fleetinggarden", "matis/groveofconfusion", "matis/hereticshovel", "matis/hiddensource", "matis/knollofdissent", "matis/majesticgarden", "matis/upperbog" ] ] ]
