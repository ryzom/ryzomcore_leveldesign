...
# *** CONTINENT FILE ***
ContinentSheet = "lepaysmalade"
ContinentFile = "lepaysmalade(zorai)/" + ContinentSheet + ".continent"
...
AiWmapVerbose = 0
AiWmapStartPoints = [ ]
AiWmapStartPoints += [ ContinentName + " 9740 -3060" ] # Zorail main land
AiWmapStartPoints += [ ContinentName + " 7772 -4876" ] # Zorail newbieland
