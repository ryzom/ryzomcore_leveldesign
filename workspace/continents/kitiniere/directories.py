...
#ShapeSourceDirectories += [ "stuff/" + ContinentName + "/decors/constructions" ]
#ShapeSourceDirectories += [ "stuff/" + ContinentName + "/sky" ]
#ShapeSourceDirectories += [ "stuff/" + EcosystemName + "/sky_" + ContinentName ]
...
#MapSourceDirectories += [ "stuff/" + EcosystemName + "/sky_" + ContinentName ]
...
#IgOtherSourceDirectories += [ "stuff/" + ContinentName + "/decors/constructions" ]
#IgOtherSourceDirectories += [ "stuff/" + ContinentName + "/sky" ] # The canopee in the sky
#IgOtherSourceDirectories += [ "stuff/" + EcosystemName + "/sky_" + ContinentName ]
#IgOtherSourceDirectories += [ "landscape/water/meshes/" + EcosystemName ]
...
#ShapeLookupDirectories += [ ContinentPath + "/shape_optimized" ]
ShapeLookupDirectories += [ "continents/terre/shape_optimized" ]
ShapeLookupDirectories += [ "continents/terre/shape_with_coarse_mesh" ]
...
#ShapeLookupDirectories += [ "continents/terre/map_export" ]
#ShapeLookupDirectories += [ "continents/terre/map_uncompressed" ]
