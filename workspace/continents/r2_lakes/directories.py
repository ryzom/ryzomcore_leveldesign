...
ShapeSourceDirectories += [ "landscape/water/meshes/" + EcosystemName + "/r2_lacustre" ]
...
IgOtherSourceDirectories += [ "landscape/water/meshes/" + EcosystemName + "/r2_lacustre" ] # The canopee in the sky
