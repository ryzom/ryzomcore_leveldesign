...
AiWmapVerbose = 0
AiWmapStartPoints = [ ]
AiWmapStartPoints += [ ContinentName + " 14738 -1005" ] # matis island 1
AiWmapStartPoints += [ ContinentName + " 16037 -825" ] # matis island 2
AiWmapStartPoints += [ ContinentName + " 17414 -885" ] # matis island 3
