...
AiWmapVerbose = 0
AiWmapStartPoints = [ ]
AiWmapStartPoints += [ ContinentName + " 21336 -29654" ]
AiWmapStartPoints += [ ContinentName + " 22453 -29993" ]
AiWmapStartPoints += [ ContinentName + " 23608 -29851" ]
AiWmapStartPoints += [ ContinentName + " 25286 -30076" ]
AiWmapStartPoints += [ ContinentName + " 26747 -29898" ]
