...
AiWmapVerbose = 0
AiWmapStartPoints = [ ]
AiWmapStartPoints += [ ContinentName + " 21668 -24431" ] # fyros island 1
AiWmapStartPoints += [ ContinentName + " 23351 -24571" ] # fyros island 2
AiWmapStartPoints += [ ContinentName + " 23218 -24335" ] # fyros island 2
AiWmapStartPoints += [ ContinentName + " 25633 -24223 62" ] # Aelius Dunes
