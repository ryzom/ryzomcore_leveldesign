...
SkelSourceDirectories += [ "stuff/tryker/agents/monsters/kami/kami_caster/animations/skeletons" ]
SkelSourceDirectories += [ "stuff/tryker/agents/monsters/kami/kami_fighter/animations/skeletons" ]
...
SkelSourceDirectories += [ "stuff/tryker/agents/monsters/kami/kami_warlord/animations/skeletons" ]
SkelSourceDirectories += [ "stuff/tryker/agents/monsters/kami/kami_warrior/animations/skeletons" ]
...
#ShapeSourceDirectories += [ "stuff/tryker/agents/monsters/aquatique_monture/sagass" ]
...
ShapeSourceDirectories += [ "stuff/tryker/agents/monsters/kami/kami_caster" ]
ShapeSourceDirectories += [ "stuff/tryker/agents/monsters/kami/kami_fighter" ]
...
ShapeSourceDirectories += [ "stuff/tryker/agents/monsters/kami/kami_warlord" ]
ShapeSourceDirectories += [ "stuff/tryker/agents/monsters/kami/kami_warrior" ]
...
AnimSourceDirectories += [ "stuff/tryker/agents/monsters/kami/kami_caster/animations/anims" ]
AnimSourceDirectories += [ "stuff/tryker/agents/monsters/kami/kami_fighter/animations/anims" ]
...
AnimSourceDirectories += [ "stuff/tryker/agents/monsters/kami/kami_warlord/animations/anims" ]
AnimSourceDirectories += [ "stuff/tryker/agents/monsters/kami/kami_warrior/animations/anims" ]
